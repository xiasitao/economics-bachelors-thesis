...
def plot_human_annotation_confusion_matrix(article_hypertopic_data: pd.DataFrame, human_annotated: pd.DataFrame, n_clusters: int):
...
def evaluate_hypertopics_for_n(
    ...
    plot_topic_distribution(hypertopic_distribution, relative=relative_dist_plot, additional_title_text=distinct_text)

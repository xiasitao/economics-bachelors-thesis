...
\begin{figure}
    ...
    \caption{Schematic of the topic modelling procedure with \gls{lda}: Many models for different numbers $\ntopics$ of topics are trained, each of them yields a list of topics that are characterized by topic words, as well as topic probabilities for each article.\todo[inline]{improve}}\label{fig:topic_modelling_schema}
\end{figure}

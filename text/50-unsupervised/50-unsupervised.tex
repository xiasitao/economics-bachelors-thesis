...
\section{Discussion}
In this chapter, topic modelling was explored as a method for analyzing newspaper articles\todo{continue}
%  potential points:
% Making more interesting
% - only use articles which don't cover a topic out of certain pool of uninteresting ones
% - exclude articles whose topic matches the profession of role model
% - include other forms of text (social media, non-newspaper reports)
% Scrutinizing more
% - more effort needed to capture certain connotations, scrutinize more on word lists
% - scrutinize for higher n_topics
% Validity: